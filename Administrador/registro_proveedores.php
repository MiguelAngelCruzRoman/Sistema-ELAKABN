...
if($_SERVER["REQUEST_METHOD"] === "POST"){
    ...
    //abrimos el archivo proveedores.csv
	...
	<div id="principal">
		...
		<div id ="opciones">
			<form method ="POST" action = "<?php echo $_SERVER["PHP_SELF"]; ?>">
				...
				<input type="tel" class="form-control" name="telefono" id="telefono"  placeholder="Numero telefónico" required>
				</div>
				<div class="form-group">
				<label for="producto">Producto a proveer</label>
				<input type="text" class="form-control" name ="producto" id="producto"  placeholder="Producto a proveer" required>
				</div>
