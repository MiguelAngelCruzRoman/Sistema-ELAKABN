...
if (!isset($_SESSION['username'])) {
	...
	echo '<script type="text/javascript">alert("LA SESIÓN NO SE HA INICIADO. REDIRIGIENDO AL LOGIN"); window.location.href = "index.php";</script>';
    exit();
}
...
?>
<?php
// Código PHP para cerrar la sesión

if (isset($_GET['logout'])) {
    session_destroy(); // Destruir la sesión
	echo '<script type="text/javascript">alert("LA SESIÓN SE HA CERRADO. REDIRIGIENDO AL LOGIN"); window.location.href = "index.php";</script>';
    exit();
}
?>
<!DOCTYPE html>
...
<header>
    ...
    <div class="container mt-5">
        ...
        <div class="row mt-5">
            ...
            $archivo_csv = fopen('C:\xampp\htdocs\Sistema_ELAKABN\Archivos\ingredientes.csv', 'r');
            $products = array();
                ...
                <div class=" col-md-3 mb-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                <?php echo 'Stock: ' . $product['stock']. ' unidades'; ?>
                            </p>
                            <p class="card-text">
                                <?php echo 'Precio unitario: $' . number_format($product['price'], 2); ?>
                            </p>
                            <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                                <input type="hidden" name="product_id" value="<?php echo $product['id']; ?>">
                                <input type="hidden" name="price" value="<?php echo $product['price']; ?>">
                                <div class="form-group">
                                    <label for="quantity_<?php echo $product['id']; ?>">Cantidad a ordenar:</label>
...
if (isset($_POST['NoSeguir'])) {
	unset($_SESSION['cart']);
	echo '<script type="text/javascript">alert("LA ÚLTIMA ORDEN NO SE GUARDÓ. REDIRIGIENDO A LA PÁGINA PRINCIPAL."); window.location.href = "PaginaInicial.php";</script>';
	exit();
