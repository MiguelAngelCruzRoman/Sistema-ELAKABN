...
<header>
    ...
    <h1 class="text-center">Consultar servicios</h1>

    <div>
        <?php
        echo '<table class="table"><thead class="thead-dark"><tr><th scope="col">Nombre del servicio</th>      <th scope="col">Tipo de servicio</th>
